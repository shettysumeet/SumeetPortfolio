        ...
        <div className={styles.copyWrapper}>
          ...
          <Reveal>
            <h2 className={styles.subTitle}>
              I&apos;m a <span>Senior Developer</span> & <span>IT Architect</span>
            </h2>
          </Reveal>
          <Reveal>
            <p className={styles.aboutCopy}>
              I&apos;ve spent the last 15 years building and scaling applications for
              some renowned companies and individuals. I also create interesting self projects in my spare time.
              Let&apos;s connect!
            </p>
          </Reveal>
          <Reveal>
